...
var dataset = $.ajax("https://raw.githubusercontent.com/MUSA611-CPLN692-spring2019/datasets/master/geojson/philadelphia-garbage-collection-boundaries.geojson")

//var mydata = dataset.done(function(data){console.log(data)})
...
//var layer = L.geoJSON(dataset).addTo(map);

var myStyle = function(feature) {
  switch(feature.properties.COLLDAY){
    case 'MON': return {color: "red"};
    case 'TUE': return {color: "blue"};
    case 'WED': return {color: "black"};
  }
};
